      ...
      <div class="modal-content">
        <div class="modal-header btn btn-dark">
          <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
              <span aria-hidden="true">Deseas Eliminar el Trabajador</span>
            </button>
            ...
            <div class="card-body text-secondary">
              ...
              <center>
                <form method="post" action="sql/eliminar-usuario.php?id=<?php echo $id; ?>">
                  ...
                  <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id" value="<?php echo $row['nombres']; ?>" required><br>
                  <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id" value="<?php echo $row['apellidos']; ?>" required><br>
                  <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id" value="<?php echo $row['gerencia']; ?>" required>
